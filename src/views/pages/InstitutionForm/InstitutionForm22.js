...
const InstitutionForm = () => {
  ...
  const loadedSeedTypes = ctx.seedTypes.map(s => {
  ...
  const handleSubmit = e => {
   ...
   const allInformationFormData = new FormData();
    ...
    <Row>
      ...
      <Col md="6" xs="12" className="m-auto">
        <Form onSubmit={handleSubmit}>
          ...
          <hr></hr>
          <Form.Group>
            <Form.Label className="text-center d-block">Зарарланиши мумкин бўлган маҳсулотлар</Form.Label>
            <label>Номи</label>
            <Select
              options={loadedSeedTypes}
              isMulti
              onChange={e => {
